...
# docker
download_if_not_here '.' 'docker-ce-17.06.0.ce-1.el7.centos.x86_64.rpm' 'https://download.docker.com/linux/centos/7/x86_64/stable/Packages'

# kolla image
download_if_not_here '.' 'centos-source-registry-ocata.tar.gz' 'http://tarballs.openstack.org/kolla/images'

# cloud image
download_if_not_here '.' 'cirros-0.3.5-x86_64-disk.img' 'http://download.cirros-cloud.net/0.3.5'
